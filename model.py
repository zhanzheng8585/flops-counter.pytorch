...
class ColorizationNet(nn.Module):
    def __init__(self, midlevel_input_size=128, global_input_size=512):
        ...
        # self.fusion = nn.Linear(midlevel_input_size + global_input_size, 256)
        ...
        # self.deconv1_new = nn.ConvTranspose2d(midlevel_input_size + global_input_size, 512, kernel_size=4, stride=2, padding=1)
        ...
        self.conv1 = nn.Conv2d(midlevel_input_size + global_input_size, 256, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, midlevel_input, global_input):
        ...
        # x = self.deconv1_new(self.bn1(self.fusion(x)))
...
class ColorNet(nn.Module):
    def __init__(self):
        ...
        self.global_resnet = nn.Sequential(*list(resnet_gray_model.children())[6:9])
    ...
    def forward(self, input_image):
        ...
        global_output = self.global_resnet(midlevel_output)
